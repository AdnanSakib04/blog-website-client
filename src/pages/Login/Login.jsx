...
const Login = () => {
    ...
    return (
        ...
        <div className="  p-4 mt-8 rounded-3xl ">
            ...
            <form onSubmit={handleLogin} className="md:w-1/2 mx-auto card-body bg-[#b2d8d8]  rounded-3xl">
                <h1 className="text-4xl font-bold lg:text-5xl mt-8 text-center text-gray-950">Login</h1>
                ...
                <div className="form-control mt-6">
                    <button className="btn bg-[#66b2b2] border-none font-bold text-xl text-gray-950">Login</button>
                </div>
                ...
                <p className=" text-center mt-6 text-xl font-medium text-gray-950">Want to create an account? <Link className=" text-blue-600 font-bold" to={'/register'}>Register</Link></p>
            </form>
